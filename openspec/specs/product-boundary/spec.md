# product-boundary Specification

## Purpose

Document tip-honest supported product surface for this fork from `PRODUCT.md`.
Static honesty only — no Polymarket live connector claim; no invent live PASS.
