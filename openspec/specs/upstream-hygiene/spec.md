# upstream-hygiene Specification

## Purpose

Document tip-honest upstream pin and rebase hygiene from `UPSTREAM.md`.
Static honesty only — drift checks are documented; CI wiring of the drift
script remains optional / Unavailable unless separately Act-on'd.
