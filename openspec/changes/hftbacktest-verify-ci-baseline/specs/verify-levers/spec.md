...
<!-- Tip body remains in force. This MODIFIED clarifies that the first-missing Act-on is the minimum verify workflow in R-VER-04, while presence still does not invent PASS (R-VER-06). -->
